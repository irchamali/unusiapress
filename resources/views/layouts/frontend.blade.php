...
<html lang="en">
    <head>
        ...
        <meta content="Mahakarya terbaik para Dosen Unusia disuguhkan untuk masyarakat Indonesia." name="description">
        <meta content="{{ $title ?? 'App Toko' }}" name="keywords">
        <meta property="og:locale" content="ID_id"/>
        <meta property="og:type" content="website"/>
        <meta property="og:image" content="{{ asset('assets/img/unu-core.png') }}">
        <!-- Bootstrap CSS -->
        <link rel="shortcut icon" href="{{ asset('assets/img/unu-core.png') }}">
